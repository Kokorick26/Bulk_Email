...
export default function Contact() {
    ...
    return (
        <div className="pt-32 pb-32 px-6 bg-brand-dark min-h-screen text-white relative overflow-hidden font-body">
            {/* Background Effects */}
                    ...
                    {submitted ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    rows={4}
                                    className="bg-white/5 border-white/10 text-white focus:border-brand-orange resize-none"
                                    placeholder="Tell us about your needs..."
                                    required
                                />
                            </div>

                            <Button className="w-full h-12 bg-brand-orange hover:bg-brand-orange/90 text-white font-bold rounded-xl group">
